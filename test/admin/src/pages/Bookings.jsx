...
export default function Bookings() {
  ...
  return (
    <div className="page">
      <div className="page-head row">
        <div>
          <h2 className="page-head-title">
            <CalendarCheck className="page-ico-inline" size={26} strokeWidth={1.75} aria-hidden />
            Online-Buchungen
          </h2>
      ...
      <CrmToolbar value={q} onChange={(v) => setQ(v)} placeholder="Modell, Name, E-Mail…">
      ...
      {!loading && (
        <motion.div className="table-scroll" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          {!items?.length ? <div className="muted padded">Keine Buchungen.</div> : null}
        </motion.div>
      )}
    </div>
  );
